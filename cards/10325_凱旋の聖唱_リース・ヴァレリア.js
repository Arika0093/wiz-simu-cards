{
	...
	ape: "GW2015",
	as1: {
		desc: "<回復・攻撃強化>火・雷属性の味方のHPを回復(13%)、さらに火・雷属性の味方の攻撃力をアップ(30%)、SPスキル封印状態時、さらに攻撃力をアップ(90%)",
	...
	as2: {
		desc: "<回復・攻撃強化>火・雷属性の味方のHPを回復(16%)、さらに火・雷属性の味方の攻撃力をアップ(30%)、SPスキル封印状態時、さらに攻撃力をアップ(90%)",
