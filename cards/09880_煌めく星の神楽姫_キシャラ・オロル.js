{
	...
	as1: {
		...
		proc: [as_guard(0.10, [1,1,1,1,1], 3), add_cond(ChainEnhance(0, [1,0,0,0,0], 3), as_singleattr_num(0, 0.15))],
	},
	ss1: {
	...
	as2: {
        ...
        proc: [as_guard(0.10, [1,1,1,1,1], 3), add_cond(ChainEnhance(0, [1,0,0,0,0], 3), as_singleattr_num(0, 0.20))],
	},
	ss2: {
