{
	...
	is_dist: true,
	as1: {
		desc: "<属性特効連撃>水・闇属性の敵単体へ特効3連撃(300%)、解答が早いほどさらにアップ(50%)",
		proc: add_cond(ChainDualAttrAttack(3.0, 0, 3, [0,1,0,0,1]), as_timedep(0.5)),
	},
	ss1: {
		desc: "<特効大魔術>敵全体へ雷属性のダメージ(300%)、平均解答時間が早いほどさらに水属性の敵には特効ダメージ(50%)",
		turn: 6,
	...
	as2: {
		desc: "<属性特効連撃>水・闇属性の敵単体へ特効3連撃(400%)、解答が早いほどさらにアップ(50%)",
		proc: add_cond(ChainDualAttrAttack(4.0, 0, 3, [0,1,0,0,1]), as_timedep(0.5)),
	},
	ss2: {
		desc: "<特効大魔術>敵全体へ雷属性のダメージ(500%)、平均解答時間が早いほどさらに水属性の敵には特効ダメージ(100%)",
		turn: 9,
