{
	...
	ape: "新人王",
	as1: {
		desc: "<連撃>4チェインで敵単体を5回連続攻撃(300%)、HP50%以上でさらにダメージアップ(200%)",
		proc: [ChainDualAttack(3.0, 4, 5), add_cond(ChainDualAttack(5.0, 4, 5), when_hp_more(0.5))],
	},
	ss1: {
		desc: "<複属性ダメージ強化>5ターンの間、水属性の攻撃力をアップ(100%)、複属性が光属性だとさらにアップ(50%) 。さらに味方全体のHPを回復する(50%)",
		turn: 6,
	...
	as2: {
		desc: "<連撃>4チェインで敵単体を5回連続攻撃(400%)、HP50%以上でさらにダメージアップ(200%)",
		proc: [ChainDualAttack(4.0, 4, 5), add_cond(ChainDualAttack(6.0, 4, 5), when_hp_more(0.5))],
	},
	ss2: {
		desc: "<複属性ダメージ強化>8ターンの間、水属性の攻撃力をアップ(100%)、複属性が光属性だとさらにアップ(150%) 。さらに味方全体のHPを完全回復する",
		turn: 10,
		proc: [ss_enhance_all_subattr(1.0, 2.5, 8, [0,1,0,0,0], [0,0,0,1,0]), ss_heal(1)],
	},
	Lawake: [
