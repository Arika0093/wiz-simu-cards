{
	...
	ss1: {
		desc: "<複属性回復>雷属性の味方のHPを回復(40%)、複属性が光属性だとさらに回復(40%)",
		turn: 3,
		proc: [ss_heal_subattr([0,0,1,0,0], 0.4, [0,0,0,1,0], 0.8)],
	},
	awakes: [
	...
	ss2: {
		desc: "<複属性回復>雷属性の味方のHPを回復(40%)、複属性が光属性だとさらに回復(40%)",
		turn: 6,
		proc: [ss_addchain(2), ss_heal_subattr([0,0,1,0,0], 0.4, [0,0,0,1,0], 0.8)],
	},
	Lawake: [
		Statusup(0,1000),
		Statusup(1000,0),
