{
	...
	ss1: {
		desc: "<一閃斬撃大魔術>スキル反射を無視し、敵全体へ水属性のダメージ(650%)、さらに攻撃した敵の数が多いほどチェインプラス(上限:5体、最大31チェイン)",
		turn: 8,
		proc: [ss_damage_slash_all(6.5, [1]), ss_ignore_skillcounter()],
	},
	awakes: [
	...
	ss2: {
		desc: "<一閃斬撃大魔術>スキル反射を無視し、敵全体へ水属性のダメージ(950%)、さらに攻撃した敵の数が多いほどチェインプラス(上限:5体、最大31チェイン)",
		turn: 11,
		proc: [ss_damage_slash_all(9.5, [1]), ss_ignore_skillcounter()],
	},
	Lawake: [
		Statusup(0,1000),
