{
	...
	as1: {
		...
		proc: [ChainEnhance(0.8, [0,1,0,0,0], 7), as_guard(0.10, [1,1,1,1,1], 7)],
	},
	ss1: {
		desc: "<ダメージ強化>8ターン溜めた後、30ターン水属性の味方の攻撃力をアップ(350%)",
		turn: 3,
		charged: 8,
		proc: [ss_enhance_all(3.5, 30, [0,1,0,0,0])],
	},
	awakes: [
	...
	as2: {
		...
		proc: [ChainEnhance(1.0, [0,1,0,0,0], 7), as_guard(0.10, [1,1,1,1,1], 7)],
	},
	ss2: {
