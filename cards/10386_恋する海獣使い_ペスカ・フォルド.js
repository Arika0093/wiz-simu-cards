{
	...
	ss1: {
		desc: "<多弾魔術>スキル反射を無視し、敵単体へ火・雷属性の5回連続ダメージ(300%)。20チェインでさらに5回連続ダメージ(700%)",
		turn: 10,
		proc: [ss_damage_s(ss_chain_cond(20, 10, 3), [0,2], ss_chain_cond(20, 10, 5)), ss_ignore_skillcounter()],
	},
	awakes: [
