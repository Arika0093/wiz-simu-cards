{
	...
	alias: ["あさひなれんじ"],
	as1: {
		desc: "<チェイン攻撃>4チェインでダメージアップ(150%)、解答が早いほどさらにアップ(125%)",
		proc: add_cond(ChainAttack(1.5, 4), as_timedep(1.25)),
	},
	ss1: {
		desc: "<大魔術>スキル反射を無視し、敵全体へ雷・光属性のダメージ(80%)、平均解答が早いほどさらにダメージ(40%)",
		turn: 4,
	...
	as2: {
		desc: "<チェイン攻撃>4チェインでダメージアップ(250%)、解答が早いほどさらにアップ(125%)",
		proc: add_cond(ChainAttack(2.5, 4), as_timedep(1.25)),
	},
	ss2: {
		desc: "<大魔術>スキル反射を無視し、敵全体へ雷・光属性のダメージ(110%)、平均解答が早いほどさらにダメージ(40%)",
		turn: 6,
