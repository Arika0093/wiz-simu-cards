{
	...
	ss1: {
		...
		turn: 4,
		proc: [panel_attr_guard([1,1,1,1,1], 0.25), panel_attr_guard([1,1,1,1,1], 0.65), panel_skillboost(1), panel_skillboost(5), panel_chainplus(2), panel_chainplus(10), panel_attackup(0.5), panel_attackup(3.0)],
	},
	awakes: [
		Costdown(10),
