{
	...
	is_dist: true,
	as1: {
		desc: "<回復>パネルの色が2色以上で雷属性の味方を回復(17%)",
		proc: ChainPanelsHeal(0, 0.17, 0.17, [0, 0, 1, 0, 0], 0),
	},
	ss1: {
	...
	as2: {
		desc: "<回復>パネルの色が2色以上で雷属性の味方を回復(20%)",
		proc: ChainPanelsHeal(0, 0.20, 0.20, [0, 0, 1, 0, 0], 0),
	},
	ss2: {
		desc: "<特殊パネル変換>ジャンルパネルにチェインとスキルチャージの効果を付与(1、1)、パネルの色が増す度さらにアップ（上限値:3、2）",
		turn: 5,
