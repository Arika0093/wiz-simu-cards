{
	...
	ss1: {
		desc: "<詠唱大魔術>スキル反射を無視し、敵単体へ水属性のダメージ、クイズに5問解答し、解答時間が早いほどさらにダメージ(基本:1000% 最大:3000%)",
		turn: 7,
		proc: [ss_damage_s(ss_answertime(10.0, 5.0), [1], 1), ss_ignore_skillcounter()],
	},
	awakes: [
	...
	ss2: {
		desc: "<詠唱大魔術>スキル反射を無視し、敵単体へ水属性のダメージ、クイズに5問解答し、解答時間が早いほどさらにダメージ(基本:1500% 最大:3500%)",
		turn: 10,
		proc: [ss_damage_s(ss_answertime(15.0, 5.0), [1], 1), ss_ignore_skillcounter()],
	},
	Lawake: [
		Statusup(0,1000),
