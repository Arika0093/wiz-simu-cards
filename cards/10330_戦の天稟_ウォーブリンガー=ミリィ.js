{
	...
	ape: "黄昏メアレスⅠ",
	as1: {
		desc: "<快調攻撃>残りHPが70%以上でダメージアップ(400%)、10チェインで更にアップ(600%)",
		proc: [add_cond(ChainAttack(4.0, 0), when_hp_more(0.7)), add_cond(ChainAttack(10.0, 10), when_hp_more(0.7))],
	},
	ss1: {
	...
	as2: {
		desc: "<快調攻撃>残りHPが70%以上でダメージアップ(400%)、10チェインで更にアップ(600%)",
		proc: [add_cond(ChainAttack(5.0, 0), when_hp_more(0.7)), add_cond(ChainAttack(11.0, 10), when_hp_more(0.7))],
	},
	ss2: {
