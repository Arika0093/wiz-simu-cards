{
	...
	ape: "黄昏メアレスⅡ",
	as1: {
		desc: "<複属性攻撃強化>10チェインで火属性の攻撃力をアップ(30%)、複属性を持つ精霊はさらにアップ(170%)",
		proc: [ChainEnhance_SubAttr(0.3, 2.0, [1,0,0,0,0], [0,1,1,1,1], 10)],
	},
	ss1: {
	...
	as2: {
		desc: "<複属性攻撃強化>10チェインで火属性の攻撃力をアップ(60%)、複属性を持つ精霊はさらにアップ(170%)",
		proc: [ChainEnhance_SubAttr(0.6, 2.3, [1,0,0,0,0], [0,1,1,1,1], 10)],
	},
	ss2: {
