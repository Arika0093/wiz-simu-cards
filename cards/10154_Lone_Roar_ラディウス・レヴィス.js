{
	...
	ss1: {
		desc: "<一閃斬撃大魔術>スキル反射を無視し、敵全体へ火属性のダメージ(250%)、さらに攻撃した敵の数が多いほどチェインプラス(上限:5体、最大31チェイン) ",
		turn: 8,
		proc: [ss_damage_slash_all(2.5, [0]), ss_ignore_skillcounter()],
	},
	awakes: [
		Costdown(20),
	...
	ss2: {
		desc: "<一閃斬撃大魔術>スキル反射を無視し、敵全体へ火属性のダメージ(550%)、さらに攻撃した敵の数が多いほどチェインプラス(上限:5体、最大31チェイン) ",
		turn: 11,
		proc: [ss_damage_slash_all(5.5, [0]), ss_ignore_skillcounter()],
	},
	Lawake: [
		Statusup(500,0),
